    ...
    def auto_change_size(self):
        ...
        if self.auto_change == True:
            ...
            if self.pb_mapping_table_hit > self.metadata.mapping_table.leaftl_hit & self.metadata.mapping_table.leaftl_size >= 50 * MB: # mapping table lower
                ...
                if self.metadata.pb_mapping_table_size >= 50 * MB:
        ...
        print("---size---")
        print(self.metadata.pb_mapping_table_size, self.metadata.mapping_table.leaftl_size, self.rw_cache_hot.capacity * 4 * 1024, self.rw_cache_cold.capacity * 4 * 1024)
        print(self.metadata.mapping_table.leaftl_size)
        print(self.rw_cache_hot.capacity * 4 * 1024)
        print(self.rw_cache_cold.capacity * 4 * 1024)
