...
class Ftl(ftlbuilder.FtlBuilder): # dftl，sftl，leaftl的初始化均使用这个类
    ...
    def auto_change_size(self):
        ...
        print("---size---")
        print(self.metadata.pb_mapping_table_size/1024/1024, self.metadata.mapping_table.leaftl_size, self.rw_cache_hot.capacity * 4 * 1024, self.rw_cache_cold.capacity * 4 * 1024)
